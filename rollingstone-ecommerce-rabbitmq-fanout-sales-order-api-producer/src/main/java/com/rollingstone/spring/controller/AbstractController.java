...
public abstract class AbstractController implements ApplicationEventPublisherAware {
	...
	Counter http400ExceptionCounter = Metrics.counter("com.rollingstone.SalesOrderController.HTTP400");

	Counter http404ExceptionCounter = Metrics.counter("com.rollingstone.SalesOrderController.HTTP404");
